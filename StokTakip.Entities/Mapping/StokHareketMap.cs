...
namespace StokTakip.Entities.Mapping
{
    public class StokHareketMap:EntityTypeConfiguration<StokHareket>
    {
        public StokHareketMap()
        {
            ...
            this.Property(p => p.BarkodTuru).HasMaxLength(20);
            ...
            //this.Property(p => p.IndirimTutari).HasPrecision(12,2); Silindi
            //this.Property(p => p.ToplamTutar).HasPrecision(12,2); Silindi
            ...
            this.Property(p => p.KonumKodu).HasMaxLength(35);
            ...
            //this.Property(p => p.IndirimTutari).HasColumnName("IndirimTutari"); Silindi
            //this.Property(p => p.ToplamTutar).HasColumnName("ToplamTutar"); Silindi
            ...
            this.Property(p => p.KonumKodu).HasColumnName("KonumKodu");
