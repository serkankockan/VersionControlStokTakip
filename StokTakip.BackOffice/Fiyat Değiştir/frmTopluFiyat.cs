...
namespace StokTakip.BackOffice.Fiyat_Değiştir
{
    public partial class frmTopluFiyat : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnCikart_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Seçilen bir stok yok."+Environment.NewLine+"Ekle butonundan ürün ekleyebilirsiniz.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
        ...
        private void btnFiyatDegistir_Click(object sender, EventArgs e)
        {
            if (gridView1.RowCount==0)
            {
                MessageBox.Show("Seçilen bir stok bulunamadı." + Environment.NewLine + "Ekle butonundan ürün ekleyebilirsiniz.", "Uyarı",MessageBoxButtons.OK,MessageBoxIcon.Stop);
                return;
            }

            frmFiyatDegisitir form = new frmFiyatDegisitir();
            form.ShowDialog();
